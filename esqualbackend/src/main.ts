...
async function bootstrap() {
  ...
  const swaggerConfig = new DocumentBuilder()
    .setTitle('Exchange API Documentation')
    .setDescription(
      'Detailed API documentation for the Exchange platform, offering endpoints for managing user accounts and trading operations.',
    )
    .addBearerAuth()
